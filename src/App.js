    ...
    <div className="summary">
      ...
      <div>
        ...
        <p>
          <span>⭐️</span>
          <span>
            {Number.isNaN(avgImdbRating) ? "N/A" : avgImdbRating.toFixed(2)}
          </span>
        </p>
        <p>
          <span>🌟</span>
          <span>
            {Number.isNaN(avgUserRating) ? "N/A" : avgUserRating.toFixed(2)}
          </span>
        </p>
        <p>
          <span>⏳</span>
          <span>{Number.isNaN(avgRuntime) ? "N/A" : avgRuntime} min</span>
        </p>
      </div>
    </div>
  );
